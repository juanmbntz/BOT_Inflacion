...
dag = DAG(
    dag_id="scrapper_precios",
    description="Scrapper para precios de supermercado",
    max_active_runs=1,
    catchup=False,
    start_date=datetime(2022, 9, 2, 0 ,0),
...
#        subject="precios_incrementos",
#        files=[f"/opt/airflow/dags/files/{env}precios_coto_increm.csv"],
#        html_content=f" <h3>Ya estan los precios del dia {{{{ ds }}}} !</h3>"
#)
